...
class _NowPlayingScreenState extends State<NowPlayingScreen>
  ...
  Future<void> _generatePalette() async {
    ...
    if (song.imageUrl.startsWith('assets/')) {
      bytes = (await rootBundle.load(song.imageUrl)).buffer.asUint8List();
    } // else network handled by SongImage/cached
              ...
              Expanded(
                child: ListView(
                  children: [
                    ...
                    // Mock timed lyrics - enhance with position
                  ],
                ),
              ),
            ],
            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  // Album art with blur backdrop & visualizer
                  Expanded(
                    child: Stack(
                                    ...
                                    child: Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Transform.scale(
                                          ...
                                          child: SongImage(song: song, width: 320, height: 320),
                                        ),
                                      ),
                                    ),
                                  ),
                          ...
                          children: [0.5, 1.0, 1.5, 2.0]
                              .map(
                                (speed) => _neumorphicIconButton(
                                  icon: Icons.speed,
                                  color: player.playbackSpeed == speed
                                      ? dominantColor
                                      : Colors.white70,
                                  size: 24,
